...
export default function UserEditor() {
  ...
  const UserSchema = Yup.object().shape({
    ...
    name: Yup.string().required('* Name name required!').min(3, '* Name too short!').max(10, '* Name too long!'),
              ...
              <Form>
                ...
                <div className='form-item'>
                  ...
                  <div className='editBtns'>
                    ...
                    <button className='deleteBtn' type='button' onClick={() => navigate('/admin')}> <FcCancel /> </button>
                  </div>
              </Form>
